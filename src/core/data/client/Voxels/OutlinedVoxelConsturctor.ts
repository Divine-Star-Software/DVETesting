...
} from "divine-voxel-engine";
import type { DataTool } from "divine-voxel-engine/Tools/Data/DataTool";
import  { VoxelTemplater, DVEC } from "divine-voxel-engine/Constructor";
...
export class OutlinedVoxelConstructor implements VoxelConstructor {
  constructor(
    public id: string,
    textures: [base: ConstructorTextureData, overlay: ConstructorTextureData]
  ) {
