...
import { GenerateStairPillar } from "@core/Gen/Functions/StairPillar.js";
import { GenerateStairRoof } from "@core/Gen/Functions/StairRoof.js";
type DimensionTempleData = {
  stone: string;
  stair: string;
  ether: string;
  lamp: string;
...
const DimensionTempleVoxels: Record<string, DimensionTempleData> = {
  crimson: {
...
export function GenerateDimensionTemple(
  brush: BrushTool,
  sx: number,
  sy: number,
  sz: number,
  templeDimension: string
) {
