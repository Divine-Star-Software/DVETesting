...
(async function () {
    ...
    for (let i = 0; i < navigator.hardwareConcurrency - 2; i++) {
        constructorWorkers.push(new Worker(new URL("./Constructor/constructor.js", import.meta.url), {
            type: "module",
        }));
    }
   ...
   */
    const richWorldWorker = new Worker(new URL("./RichWorld/richworld.js", import.meta.url), {
        type: "module",
    });
    /*
  Register Textures
