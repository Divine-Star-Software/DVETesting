...
const GameSession = {
    ...
    startSession() {
        divine_voxel_engine_World__WEBPACK_IMPORTED_MODULE_1__.DVEW.nexusComm.runTasks("start-world", []);
        divine_voxel_engine_World__WEBPACK_IMPORTED_MODULE_1__.DVEW.nexusComm.runTasks("set-player-position", [0, 70, 0]);
